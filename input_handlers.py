...
class GameOverEventHandler(EventHandler):
    def on_quit(self) -> None:
        ...
        if os.path.exists(file):
            os.remove(file)  # Deletes the active save file.
...
class CharacterScreenEventHandler(AskUserEventHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        console.draw_frame(x=x, y=y, width=width, height=7, title=self.TITLE,
            clear=True, fg=colour.white, bg=colour.black,
        )
...
class InventoryEventHandler(AskUserEventHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        console.draw_frame(x=x, y=y, width=width, height=height,
            title=self.TITLE, clear=True, fg=colour.white, bg=colour.black,
        )
...
class AreaRangedAttackHandler(SelectIndexHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        console.draw_frame(x=x - self.radius - 1, y=y - self.radius - 1,
            width=self.radius ** 2, height=self.radius ** 2, fg=colour.red,
            clear=False,
        )
